...
namespace QQBot.MiraiHttp.Util
{
    public static class StringExt
    {
        ...
        /// <returns></returns>
        public static bool StartWith(this string str, IEnumerable<string> prefixes, StringComparison comparer = StringComparison.Ordinal)
        {
