...
public static class ConfigurationManager
{
    ...
    private static void WarnMissingConfiguration(PluginConfiguration config)
    {
        ...
        WarnIfEmpty("osu.clientId", config.Osu?.ClientId);
        WarnIfEmpty("osu.clientSecret", config.Osu?.ClientSecret);
        WarnIfEmpty("chunithm.devToken", config.Chunithm?.DevToken);
        WarnIfEmpty("chunithm.tokenLouis", config.Chunithm?.TokenLouis);
        WarnIfEmpty("chunithm.rinNetKeyChip", config.Chunithm?.RinNetKeyChip);
        WarnIfEmpty("chunithm.allNetKeyChip", config.Chunithm?.AllNetKeyChip);
        WarnIfEmpty("maimai.secret.maiSalt", config.MaiMai?.Secret?.MaiSalt);
        WarnIfEmpty("maimai.secret.aimeSalt", config.MaiMai?.Secret?.AimeSalt);
        WarnIfEmpty("maimai.secret.aesKey", config.MaiMai?.Secret?.AesKey);
        WarnIfEmpty("maimai.secret.aesIv", config.MaiMai?.Secret?.AesIv);
    }
